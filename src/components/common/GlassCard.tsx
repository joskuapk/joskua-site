...
type GlassCardProps = React.PropsWithChildren<{
  className?: string;
  radius?: number; // px
  displacementScale?: number; // how strong the warping is
}>;
...
export default function GlassCard({
  ...
  // Keep the filter id stable per instance (avoids collisions if you render multiple cards)
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Displacement map image (your base64) */}
          <feImage
          ...
          {/* Use the map to displace the glass layer */}
          <feDisplacementMap
            in="SourceGraphic"
            in2="map"
        ...
        style={
          {
            ...
            ["--glass-filter" as any]: `url(#${filterId})`,
